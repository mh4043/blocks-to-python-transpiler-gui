...
import pythonTranslatorReducer, {pythonTranslatorInitialState} from './python-translator';
...
const guiInitialState = {
    ...
    pythonTranslator: pythonTranslatorInitialState
};
...
const guiReducer = combineReducers({
    ...
    pythonTranslator: pythonTranslatorReducer,
});
